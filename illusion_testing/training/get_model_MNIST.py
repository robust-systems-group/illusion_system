...
state_dict = torch.load('./checkpoints/mnist_model_quant.pth')
...
np.savez('data_MNIST',data=data_set,labels=gt)
data_q = data_q.view([-1,])
f = open('data_mnist.c', 'w') 
