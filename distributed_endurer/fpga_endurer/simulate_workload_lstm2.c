...
char filename[200] = "/pool0/zainabk/illusion_system/c_models/c_lstm2/lstm_write_pattern.txt";
...
int main() {
    ...
    for (int i =0; i<8; i++) {
        sprintf(init_filename, "../../illusion_testing/programs/lstm/MODEILLUSION/FINAL/NONV/NOTIME/CHIP%d/dmem.mem",i);
        printf("Load file %s\n", init_filename);
