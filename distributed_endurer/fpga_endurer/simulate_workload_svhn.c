...
char filename[200] = "/pool0/zainabk/illusion_system/c_models/c_svhn/svhn_write_pattern.txt";
...
int main() {
    ...
    printf("Loading initial write (weights)\n");
    for (int i =0; i<8; i++) {
        sprintf(init_filename, "../../illusion_testing/programs/svhn/MODEILLUSION/NOPATH/NONV/NOTIME/CHIP%d/dmem.mem",i);
        printf("Load file %s\n", init_filename);
