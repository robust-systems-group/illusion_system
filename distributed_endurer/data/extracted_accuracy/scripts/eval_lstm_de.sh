...
echo "LSTM Eval: DE using memory_lstm2 for all!"

for T in ZERO DAY WEEK MONTH YEAR TENYEAR 
do
    echo "Evaluating accuracy: $T"
    cd scripts
    python extract_model_lstm2.py --prefix ../../processed/lstm_de_clean_c --time $T
    cd ../../../c_models_test/c_lstm2/
    ./accuracy_test.sh
    cp activation_mask.c activation_mask_DE_$T\.c
    cp model_chunked_LSTM.c model_DE_$T\.c
